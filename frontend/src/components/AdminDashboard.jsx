...
function AdminDashboard() {
    ...
    const fetchPosts = async () => {
        try {
            const response = await fetch('https://tha082bme.onrender.com/api/announcements');
    ...
    const handleDeletePost = async (postId) => {
        ...
        try {
            const response = await fetch(`https://tha082bme.onrender.com/api/announcements/${postId}`, {
                method: 'DELETE'
            });
